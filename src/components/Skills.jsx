...
MetriX Mathematical Olympiad held on 2020 Day 1 paper</Card.Text>
                            ...
                            <Card className="skill-nbcard" ">
                                <Card.Body >
                                    <Card.Title><Card.Title align="center"><img src={darkMode ? helloDark1 : helloLight1} alt="hello" className="hello-img" width="500" href="https://aritra-12.github.io/pdfs/MMO%202020%20DAY%201.pdf /></Card.Title></Card.Title>
